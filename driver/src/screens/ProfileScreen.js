...
const ProfileScreen = () => {
  ...
  const settings = [
    ...
    { id: 2, title: 'المستندات', icon: '📄', action: () => navigation.navigate('Documents') },
    { id: 3, title: 'السيارة', icon: '🚗', action: () => navigation.navigate('CarInfo') },
      ...
      <View className="p-6" style={{ backgroundColor: colors.primary }}>
        <View className="flex-row items-center">
          ...
          <View className="mr-4 flex-1">
            <Text className="text-xl font-bold text-white">{user?.name || 'السائق'}</Text>
        ...
        <View className="mt-4 flex-row justify-between">
          <View className="items-center">
            ...
            <Text className="text-white text-xs">التقييم</Text>
          </View>
          <View className="items-center">
          ...
          <View className="items-center">
            ...
            <Text className="text-white text-xs">القبول</Text>
          </View>
        </View>
      </View>
