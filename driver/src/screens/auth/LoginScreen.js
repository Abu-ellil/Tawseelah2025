...
// Mock data
import { mockDriverLogin } from '../../utils/mockData';
...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await mockDriverLogin(email, password);
  ...
  return (
    <View className="flex-1 justify-center px-6" style={{ backgroundColor: colors.background }}>
      ...
      <View className="items-center mb-10">
        ...
        />
        <Text className="text-3xl font-bold" style={{ color: colors.primary }}>توصيلة - السائق</Text>
